...
|-------|------------|---------|-------|------|----------|
| **text-embedding-3-small** | 1536 | High | Fast | $0.02/1M | **Most use cases** (recommended) |
| **text-embedding-3-large** | 3072 | Very High | Medium | $0.13/1M | Critical applications, multilingual |
| **text-embedding-ada-002** | 1536 | Good | Fast | $0.10/1M | Legacy compatibility |
...
|-------|---------|---------|-------|------|----------|
| **gpt-4o** | 128K | Very High | Fast | $$ | **Latest & best** (recommended) |
| **gpt-4-turbo** | 128K | Very High | Fast | $$ | High-quality Q&A |
| **gpt-3.5-turbo** | 16K | High | Very Fast | $ | Simple tasks, cost-sensitive |
...
| Model | Context | Quality | Speed | Cost | Best For |
|-------|---------|---------|-------|------|----------|
| **gemini-2.0-flash-exp** | 1M | Very High | Very Fast | Free tier | **Latest experimental** |
| **gemini-1.5-pro** | 1M | Very High | Medium | Free tier | Long context, complex tasks |
| **gemini-1.5-flash** | 1M | High | Fast | Free tier | Fast responses |
